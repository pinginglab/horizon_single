...
export const verticalMenuItems = [
    new Menu (1, '仪表盘', '/', null, 'dashboard', null, false, 0),
    new Menu (2, '主机', '/hosts', null, 'line_style', null, false, 0),
    new Menu (3, '权柄', '/tokens', null, 'vpn_key', null, false, 0),
    new Menu (4, '用户', '/users', null, 'supervisor_account', null, false, 0)
