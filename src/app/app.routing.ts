...
export const routes: Routes = [
    {
        ...
        component: PagesComponent, children: [
            { path: '', loadChildren: './pages/dashboard/dashboard.module#DashboardModule', data: { breadcrumb: '仪表盘' } },
            { path: 'users', loadChildren: './pages/users/users.module#UsersModule', data: { breadcrumb: '用户' } },
            { path: 'tokens', loadChildren: './pages/token/token.module#TokenModule', data: { breadcrumb: '权柄' } },
            { path: 'hosts', loadChildren: './pages/host/host.module#HostModule', data: { breadcrumb: '主机' } },
            { path: 'dynamic-menu', loadChildren: './pages/dynamic-menu/dynamic-menu.module#DynamicMenuModule',
            ...
            { path: 'form-controls', loadChildren: './pages/form-controls/form-controls.module#FormControlsModule',
